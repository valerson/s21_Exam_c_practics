...
int main() {
  ...
  char c1 = '0', c2 = '0';
  int number = 0;
  if (scanf("%f%c%f%c", &n, &c1, &m, &c2) == 4 && (int)n == n && (int)m == m &&
      c1 == ' ' && c2 == '\n') {
    int **matrix = calloc(n, sizeof(int *));
    for (int i = 0; i < n; i++) matrix[i] = calloc(m, sizeof(int));

    int **result = calloc(m, sizeof(int *));
    for (int i = 0; i < m; i++) result[i] = calloc(n, sizeof(int));
...
//     if (scanf("%f%f", &n, &m) == 2 && n > 0 && m > 0 && (int)n == n && (int)m
//     == m)
//     {
//         int **matrix = calloc(n, sizeof(int *));
//         for (int i = 0; i < n; i++)
